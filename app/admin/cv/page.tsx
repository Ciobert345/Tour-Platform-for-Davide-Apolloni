...
import { GraduationCap, ArrowRight, MousePointerClick, Loader2 } from "lucide-react";
...
export default function CvRedirectPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      router.replace("/admin/live-editor?tab=cv");
    }, 400);
  ...
  return (
    <div className="max-w-2xl mx-auto py-16 px-4 text-center">
      ...
      <h1 className="font-serif text-2xl font-semibold text-[#1E160A] mb-2">
        Gestione Curriculum spostata nell&apos;Editor Live
      </h1>
      <p className="text-sm text-[#5C4C38] mb-6 leading-relaxed">
        Le voci di Formazione, Esperienze e Pubblicazioni del tuo Curriculum sono ora gestite direttamente dall&apos;<strong>Editor Live</strong>, con anteprima in tempo reale.
      </p>
